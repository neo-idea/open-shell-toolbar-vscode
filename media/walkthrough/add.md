Pin any shell command you run repeatedly — `pnpm dev`, `docker compose up`,
`git pull --rebase` — as a one-click button.
...
icon like `$(play)`, and whether it runs in the integrated terminal (recommended).
